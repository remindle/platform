...
function Terms() {
    return (
        <div className="py-6 lg:py-8 px-4 lg:px-8 dark:bg-white dark:text-black rounded text-left">
            <h1 className="mt-12 mb-4 font-bold">Terms and Conditions</h1>
            <p className="mb-4">Last updated: December 23, 2021</p>
            <p className="mb-4">
                Please read these terms and conditions carefully before using
                Our Service.
            </p>
            <h1 className="mt-12 mb-4 font-bold">
                Interpretation and Definitions
            </h1>
            <h2 className="mt-6 mb-2 font-semibold">Interpretation</h2>
            <p className="mb-4">
            ...
            <h2 className="mt-6 mb-2 font-semibold">Definitions</h2>
            <p className="mb-4">
            ...
            <ul>
                ...
                <li>
                    <p className="mb-4">
                        <strong>Website</strong> refers to Remindle, accessible
                        from{" "}
                        <a
                            href="https://remindle.io"
            ...
            <h1 className="mt-12 mb-4 font-bold">Acknowledgment</h1>
            <p className="mb-4">
            ...
            <h1 className="mt-12 mb-4 font-bold">Links to Other Websites</h1>
            <p className="mb-4">
            ...
            <h1 className="mt-12 mb-4 font-bold">Termination</h1>
            <p className="mb-4">
            ...
            <h1 className="mt-12 mb-4 font-bold">Limitation of Liability</h1>
            <p className="mb-4">
            ...
            <h1 className="mt-12 mb-4 font-bold">Governing Law</h1>
            <p className="mb-4">
            ...
            <h1 className="mt-12 mb-4 font-bold">Disputes Resolution</h1>
            <p className="mb-4">
            ...
            <h1 className="mt-12 mb-4 font-bold">Severability and Waiver</h1>
            <h2 className="mt-6 mb-2 font-semibold">Severability</h2>
            <p className="mb-4">
            ...
            <h2 className="mt-6 mb-2 font-semibold">Waiver</h2>
            <p className="mb-4">
            ...
            <h1 className="mt-12 mb-4 font-bold">Translation Interpretation</h1>
            <p className="mb-4">
            ...
            <h1 className="mt-12 mb-4 font-bold">Contact Us</h1>
            <p className="mb-4">
                If you have any questions about these Terms and Conditions, You
                can contact us:
            </p>
            <ul>
                <li>By email: info@remindle.io</li>
            </ul>
        </div>
    );
}
